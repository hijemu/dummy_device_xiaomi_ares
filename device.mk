...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_a2dp_offload_disabled_ble.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_a2dp_offload_disabled_ble.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ble.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ble.xml \
    ...
    $(LOCAL_PATH)/configs/audio/bluetooth_audio_policy_configuration_ble.xml:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth_audio_policy_configuration_ble.xml \
    ...
    $(LOCAL_PATH)/configs/audio/bluetooth_offload_audio_policy_configuration_ble.xml:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth_offload_audio_policy_configuration_ble.xml \
